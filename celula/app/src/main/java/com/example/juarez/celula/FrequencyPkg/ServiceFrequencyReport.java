...
public class ServiceFrequencyReport extends AppCompatActivity {
    AlertDialog alert;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frequency_reports_service_activity);
    ...
    public void ButtonServiceDateIni(View view)
    {
    ...
    public void ButtonServiceDateEnd(View view)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        final DatePicker picker = new DatePicker(this);
    ...
    private void SetDateIniTextView(DatePicker picker) {
        TextView date = (TextView) findViewById(R.id.serviceDateIniString);
    ...
    private void SetDateEndTextView(DatePicker picker) {
        TextView date = (TextView) findViewById(R.id.serviceDateEndString);
    ...
    public void ButtonServiceGenerateReport(View view)
    {
        if (cellEndDate==null || cellIniDate == null) {
            ...
            Intent serviceFreqList = new Intent(this, ServiceFrequencyReportList.class);
            startActivity(serviceFreqList);
        }
    }
